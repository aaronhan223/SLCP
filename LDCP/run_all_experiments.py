...
if __name__ == '__main__':
    if config.UtilsParams.experiment == 'prediction':
        ...
        model_list = ['random_forest', 'linear_regression']
        method_name = ['ldcp', 'cqr', 'split']
        run_pred_experiment(dataset_name='simulation_3', model_name='random_forest', method_name='ldcp', random_seed=config.UtilsParams.seed)
        ...
        run_pred_experiment(dataset_name='simulation_3', model_name='random_forest', method_name='split', random_seed=config.UtilsParams.seed)
